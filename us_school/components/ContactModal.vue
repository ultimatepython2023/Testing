		...
		>
			...
			>
				<div class="modal-content">
					<!-- Close -->
					<div class="d-flex pb-4" data-bs-dismiss="modal">
						<button
							type="button"
					...
					<div class="modal-body fancyScrollbar">
						<div class="ratio ratio-custom">
							...
							<div
								data-page="Contact"
								class="content custom-popup big h-100 container"
							>
								<!-- Content -->
								<div class="row h-100">
												...
												<div class="siteIdentity">
													...
													<div class="siteInfo mt-4">
														<div class="item">
															...
															<div class="data">
																37th Oman Street - Doki - Giza - Egypt
															</div>
														</div>
														<div class="item">
										...
										>
											<div class="col-12 col-lg-10">
												...
												<form action="#">
													...
													<!-- Supject -->
													<div class="mb-3">
														<label for="contactSupject" class="form-label"
															>Supject</label
														>
														<select
															class="form-select"
															id="contactSupject"
															aria-label="Contact Supject"
														>
															<option selected>How can I help you?</option>
													...
													>
														<div class="d-flex justify-content-center">
															<div class="text text-start mx-2">Send</div>
														</div>
													</button>
												</form>
											</div>
